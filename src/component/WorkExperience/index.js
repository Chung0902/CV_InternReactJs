    ...
    <div className="partRight">
      ...
      <div className="com">
        <h2 className="icon" style={{color:  "rgb(1, 97, 142)"}}>
          <i className="fa"></i>Dự án tham gia
        </h2>
      </div>
      <br />
      <div className="com">
        <h5 style={{color:  "rgb(1, 97, 142)"}}>Trường đại học Sư phạm Kỹ thuật</h5>
      ...
      <div className="com">
        ...
        <p>
          ...
          - Vai trò: Thiết
          kế cơ sở dữ liệu, thiết kế giao diện của website, đảm nhiệm các chức
          năng trong trang web như thêm, sửa, xóa, thống kê, tìm kiếm, lọc, ... <br/>
          - Kết quả: Hoàn thành một trang web thương mại
